            ...
            <div id="leftpanel" className='bg-white float-left h-screen grid overflow-y-scroll justify-self-center'>
                ...
                <div id="all_project_list" className="mt-[7%] space-y-4 mb-10  w-[90%] h-full justify-self-center">
                    ...
                    transition transform hover:skew-y-1 hover:border-l-8 hover:bg-indigo-300">
                        ...
                        <div className="description self-center w-3/5 pl-3 font-[400]">Web-based beat maker ~ in-progress ~</div>
                    </div>
                    ...
                    transition transform hover:skew-y-1 hover:border-l-8 hover:bg-green-100">
                        ...
                        <div className="description self-center w-3/5 pl-3 font-[400]"> Fully designed and built a website 
