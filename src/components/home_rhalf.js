...
const RightPanel = ({onAboutClick , onProjectsClick, onArtClick, onWritingClick, onMusicClick}) => {
    ...
    return (
        <div className="float-right flex flex-wrap h-screen" id="rightpanel">
            <TabSpace color={colorSet[0]} pagename="about" handleClick={onAboutClick} id="about_space"/> 
            <ContentSpace color={colorSet[1]}>
                <StarfieldAnimation/>
            </ContentSpace>
            <ContentSpace color={colorSet[2]}/>
            <TabSpace color={colorSet[3]} pagename="projects" handleClick={onProjectsClick}/>
            <ContentSpace color={colorSet[4]}/>
            <ContentSpace color={colorSet[5]}/>
            <TabSpace color={colorSet[6]} pagename="art" handleClick={onArtClick}/>
            <ContentSpace color={colorSet[7]}/>
            <ContentSpace color={colorSet[8]}>
                <ColorCircles/>
            </ContentSpace>
            <TabSpace color={colorSet[9]} pagename="writing" handleClick={onWritingClick}/>
            <ContentSpace color={colorSet[10]}/>
            <ContentSpace color={colorSet[11]}/>
            <TabSpace color={colorSet[12]} pagename="music" handleClick={onMusicClick}/>
