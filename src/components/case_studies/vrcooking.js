            ...
            <div id="leftpanel" className='bg-white float-left h-screen overflow-y-scroll overflow-hidden justify-self-center'>
                ...
                <div className=' ml-[3.5%] pb-[3vw]'>
                    <div className='flex flex-col md:flex-row justify-between mt-[2%]'>
                        <h1 id="es_title"className="underline decoration-wavy decoration-[3px] underline-offset-[13px] text-[9vw] md:text-[3.5vw] font-light self-center">VR Pancake Cooking Simulator</h1>
                        <a href="https://youtu.be/qeGczrRkh34" className="mt-[2vw] md:mt-0 mr-[5%] bg-red-400 p-[1.5%] h-min 
                        text-white self-center hover:bg-red-500 text-center">Visit Live Demo &rarr;</a>
                    </div>
                    ...
                    <div className='bg-emerald-700 h-min mt-[2.5vw] p-[10px] mr-[2vw] text-white'>
                        ...
                        <b><u>Demo Video:</u></b> <a href="https://youtu.be/qeGczrRkh34" className="text-cyan-400 font-medium hover:text-fuchsia-400">https://youtu.be/qeGczrRkh34</a> <br/>
                        </p>
                    ...
                    <div className='bg-red-800 h-min mt-[5vw] md:mt-[2.5vw] p-[10px] mr-[2vw] text-white flex flex-col'>
                        ...
                        <p className='mt-[1vw] font-light text-[15px] text-stone-200 mb-[2vw]'> 
                        ...
                        <p className='self-center text-[13px] text-stone-200 font-light'>Example Scenario</p>
                    ...
                    <div className='bg-cyan-800 h-min mt-[2.5vw] p-[10px] mr-[2vw] text-white flex flex-col'>
                        <p className='text-[5vw] md:text-[2vw] font-normal'>Technical Implementation</p>
                        <p className='mt-[1vw] font-light text-[15px] text-stone-200'> 
                        ...
                        <div className="flex flex-col">
                                <p className="self-center mb-[1.5vw]">interacting with ingredients</p>
                                ...
                                <p className="self-center mt-[5vw] md:mt-[2vw]">cooking using the ingredients and tools</p>
