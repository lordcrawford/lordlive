        ...
        <div id="about">
            <h1>
                ...
                <ul>
                    ...
                    <li>Columbia University - User Interface Design Teaching Assistant, super cool I love teaching</li>
                    <li>Columbia University - Annetta/Managirr, Product Manager, sole pm for a real-estate startup</li>
                    <li>Google - 2x Software Engineer Intern, worked in ads and youtube :D, made a lil feature on the chrome new tab page</li>
                    <li>ConEdison - Engineer Aide Intern, this was in high school but still really proud of this and the people I met here were awesome</li>
                </ul> <br/><br/>

                Organizations: <br/><br/>
                <ul>
                    <li>CORE - Columbia Organization of Rising Entrepreneurs, helped build out some dope minority-focused entrepreneurship initiatives</li>
